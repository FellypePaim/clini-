...
$body = '{"action":"detect_intent","payload":{"texto":"quero agendar"},"clinica_id":"teste"}'
...
try {
    $r = Invoke-RestMethod -Uri "https://mddbbwbwmwcvecbnfmqg.supabase.co/functions/v1/ai-gateway" -Method POST -Headers $headers -Body $body
