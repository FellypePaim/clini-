  ...
  public: {
    Tables: {
      ai_usage_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_usage_logs_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
      ...
      auditoria_global: {
        ...
        Relationships: [
          {
            foreignKeyName: "auditoria_global_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
      ...
      financeiro_categorias: {
        ...
        Relationships: [
          {
            foreignKeyName: "financeiro_categorias_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
      ...
      notificacoes_fila: {
        ...
        Relationships: [
          {
            foreignKeyName: "notificacoes_fila_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "notificacoes_fila_paciente_id_fkey"
            columns: ["paciente_id"]
            isOneToOne: false
            referencedRelation: "pacientes"
            referencedColumns: ["id"]
      ...
      pedidos_compra: {
        ...
        Relationships: [
          {
            foreignKeyName: "pedidos_compra_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
      ...
      planos: {
        Row: {
          ...
          features: Json | null
          id: string
          max_ia_chamadas_mes: number | null
      ...
      procedimento_insumos: {
        ...
        Relationships: [
          {
            foreignKeyName: "procedimento_insumos_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
      ...
      releases: {
        ...
        Relationships: [
          {
            foreignKeyName: "releases_autor_id_fkey"
            columns: ["autor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      sinais_vitais: {
        ...
        Relationships: [
          {
            foreignKeyName: "sinais_vitais_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sinais_vitais_consulta_id_fkey"
            columns: ["consulta_id"]
            isOneToOne: false
            referencedRelation: "consultas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sinais_vitais_paciente_id_fkey"
            columns: ["paciente_id"]
            isOneToOne: false
            referencedRelation: "pacientes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sinais_vitais_profissional_id_fkey"
            columns: ["profissional_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tickets_suporte: {
        ...
        Relationships: [
          {
            foreignKeyName: "tickets_suporte_clinica_id_fkey"
            columns: ["clinica_id"]
            isOneToOne: false
            referencedRelation: "clinicas"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tickets_suporte_responsavel_id_fkey"
            columns: ["responsavel_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      paciente_da_minha_clinica: {
        Args: { paciente_uuid: string }
        Returns: boolean
      }
    }
    Enums: {
      ...
      user_role: "admin" | "profissional" | "recepcao" | "superadmin"
    }
    CompositeTypes: {
      [_ in never]: never
    }
